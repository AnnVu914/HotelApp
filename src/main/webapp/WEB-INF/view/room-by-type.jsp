...
<body>
	...
	<section class="site-section">
		<div class="container">
			<div class="row">
				<div class="col-md-8">
					<h2 class="mb-5">${type} Rooms</h2>
				</div>

				<div class="col-md-4" align="right">
					<a
						href="${pageContext.request.contextPath}/room/add/${type}/${price}"
						class="btn btn-primary btn-sm"> Add a room </a>
				</div>
						...
						<div class="col-md-12 ">
							<table>
								...
								<c:forEach items="${rooms}" var="room">
									<tr>
										<th><c:out value="${room.roomNumber}"/> </th>
										<th><c:out value="${room.floor}"/> </th>
										<th><c:out value="${room.numberOfBed}"/> </th>
										<th><c:out value="${room.typeName}"/> </th>
										<th><c:out value="${room.price}"/> </th>
										<th><c:out value="${room.reservation}"/> </th>
										<td align="right">
										...
										<td align="right">
											<a href="${pageContext.request.contextPath}/room/delete/${room.roomNumber}/${room.typeName}" class="btn btn-primary btn-md btn-block" >
												Delete
											</a>
										</td>
									</tr>
