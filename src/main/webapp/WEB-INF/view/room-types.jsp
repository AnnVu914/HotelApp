			...
			<div class="row">
				<div class="col-md-4 mb-4">
					<div class="media d-block room mb-0">
						<figure>
							<img
								src="${pageContext.request.contextPath}/resources/images/img_2.jpg"
						...
						<div class="media-body">
							...
							<p>
								<form:form action="room-type-standard" method="post">
									<input type="hidden" name="type" value="Presidential"/>
									<button type="submit" class="btn btn-primary btn-sm">Book Now From $200</button>
								</form:form>
							</p>
						</div>
					</div>
				...
				<div class="col-md-4 mb-4">
					<div class="media d-block room mb-0">
						<figure>
							<img
								src="${pageContext.request.contextPath}/resources/images/img_3.jpg"
								alt="Generic placeholder image" class="img-fluid">
							<div class="overlap-text">
								<span> Featured Room <span class="ion-ios-star"></span> <span
									class="ion-ios-star"></span> <span class="ion-ios-star"></span>
						...
						<div class="media-body">
							...
							<p>
								<form:form action="room-type-standard" method="post">
									<input type="hidden" name="type" value="Delux"/>
									<button type="submit" class="btn btn-primary btn-sm">Book Now From $100</button>
								</form:form>
							</p>
						</div>
					</div>
				...
				<div class="col-md-4 mb-4">
					<div class="media d-block room mb-0">
						...
						<div class="media-body" name="roomType" value="Standard">
							<h3 class="mt-0">
							...
							<p>
								<form:form action="room-type-standard" method="post">
									...
									<button type="submit" class="btn btn-primary btn-sm">Book Now From $50</button>
								</form:form>
							</p>
						</div>
					</div>
